...
<?php
	...
	if(isset($_POST['registerClick']))
	{
		...
		else
		{
			...
			{
			$query="insert into customer (fname,lname,gender,contact,email,password,add1,add2,add3) value('$fnm','$lnm','$gender','$contact','$email','$dbpass','$add1','$add2','$add3')";
     ...
     <nav class="navbar navbar-inverse navbar-fixed-top">
		  <div class="container-fluid">
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="#">Aakrithi Art Gallery</a>
			</div>
			<div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav navbar-right top_menu">
				...
				<!--<li <?php if($page=="cart") echo 'class="active"' ?>><a href="cart.php">Cart us</a></li>-->
                                <li <?php if($page=="exhibition") echo 'class="active"' ?>><a href="exhibition.php">Exhibition</a></li>
